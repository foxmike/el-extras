...
/**
 * StringEquals.java - Streamsets expression language function for java string equals method
 * @author Michael Fox
 * @version 1.1.0
 */
...
public class StringEquals {
    ...
    @ElFunction(
            prefix = "string",
            name = "equals",
            description = "Returns a boolean from a string comparison"
    )
    public static boolean equals(
            @ElParam("inString") String inString, @ElParam("anotherString") String anotherString
    ) {
        try {
                return inString.equals(anotherString);
        } catch (Exception e) {
            return false;
        }
    }
