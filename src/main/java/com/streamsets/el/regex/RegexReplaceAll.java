...
/**
 * RegexReplaceAll.java - Streamsets expression language function for java regex replaceAll method
 * @author Michael Fox
 * @version 1.1.0
 */
...
public class RegexReplaceAll {
    ...
    public static String replaceAll(
        ...
        try {
            return Pattern.compile(regex).matcher(inString).replaceAll(replacement);
        } catch (Exception e) {
            return inString;
        }
    }
